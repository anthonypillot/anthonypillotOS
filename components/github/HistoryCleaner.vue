<template>
  <div id="github-history-cleaner" class="flex justify-center space-y-10 divide-y divide-gray-900/10">
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-x-8 gap-y-8">
      <div class="px-4 sm:px-0">
        ...
        <p class="mt-1 text-sm leading-6 text-gray-400">
          This tool will help you clean up your GitHub history.<br />Your GitHub Personal Access Token will not be stored.<br />If you want
          to learn more about how we use your token,<br />please see how we use your token in our
      ...
      <div>
          ...
          <div class="px-4 py-6 sm:px-8 sm:py-6">
            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div class="sm:col-span-4">
                ...
                <p class="text-sm leading-6 text-gray-400">Be sure that your token will never be stored.</p>
                ...
                <p v-if="validation.githubPatIsNotValid" class="mt-2 text-sm text-red-600">
        ...
        <div v-if="result" class="pt-8">
          <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
            <div class="px-4 py-6 sm:px-8 sm:py-6">
              <div class="px-4 sm:px-0">
                <div ref="historyCleanerResult" class="flex">
                ...
                <div v-if="result.workflows">
                  <p class="pt-1 text-gray-900 font-semibold leading-7">Workflow deleted</p>
                  <p class="text-sm leading-6 text-gray-600">
                    Number of workflow runs deleted: <span class="font-semibold">{{ result.workflows }}</span
                    >.
                  </p>
                </div>
              </div>
...
const historyCleanerResult = ref<HTMLDivElement | null>(null);
...
watch(historyCleanerResult, (updated) => {
  if (updated) {
    historyCleanerResult.value?.scrollIntoView({ behavior: "smooth" });
  }
});
</script>
